"""
Сидοрοв Αлекϲандр Βладимирοвич
...
"""
a = 'Сидοрοв Αлекϲандр Βладимирοвич'
""" Задание №1
...
print('№1 ' + str(fio == ['Сидοрοв', 'Αлекϲандр', 'Βладимирοвич']))
...
"""------------ конец блока редактирования----------------"""
print('№7 ' + str(surname_list == ['С', 'и', 'д', 'ο', 'р', 'ο', 'в']))
...
"""------------ конец блока редактирования----------------"""
print('№8 ' + str(surname_tuple == ('С', 'и', 'д', 'ο', 'р', 'ο', 'в')))
...
"""------------ конец блока редактирования----------------"""
print('№10 ' + str(res == [(0, 'С'), (1, 'и'), (2, 'д'), (3, 'ο'), (4, 'р'), (5, 'ο'), (6, 'в')]))
...
"""------------ конец блока редактирования----------------"""
print('№11 ' + str(res == ['в', 'ο', 'р', 'ο', 'д', 'и', 'С']))
